<div class="sub-bar search-bar">
  <div class="container cf">
    <form role="search" method="get" id="event-searchform" action="<?php bloginfo('home'); ?>/events">
      <div>
        <input type="text" placeholder="Enter a city or state and hit enter..." name="s" id="s" class="search-input"<?php if(is_search()) { echo ' value="' . get_search_query() . '"'; } ?> />
